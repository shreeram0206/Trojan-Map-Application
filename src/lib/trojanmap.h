...
class TrojanMap {
 public:
  ...
  // path.)
  void TSP_BruteForceHelper(std::string start, std::string current_node, 
                            double current_cost, std::vector<std::string> &current_path,
                            double &minDist, std::vector<std::string> &min_path,
                            std::vector<std::string> location_ids,
                            std::pair<double, std::vector<std::vector<std::string>>> &records);

  void TSP_BacktrackingHelper(std::string start, std::string current_node, 
                              double current_cost, std::vector<std::string> &current_path,
                              double &minDist, std::vector<std::string> &min_path,
                              std::vector<std::string> location_ids,
                              std::pair<double, std::vector<std::vector<std::string>>> &records);

  std::vector<std::string> TSP2optSwap(std::vector<std::string> &existing_path, int i, int k);
  ...
  bool CycleHelper(std::string current_id, 
